    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
        ...
        <li class="active"><a href="pages/operations/addAuthor.jsp"><i class="fa fa-circle-o text-yellow"></i> <span>添加作者</span></a></li>
              ...
              <div class="box-body">
                <form class="form-horizontal" action="addAuthor">
                  <div class="form-group">
                    <label for="inputAuthor" class="col-sm-2 control-label">姓名</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputAuthor" name="Author" placeholder="姓名">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputAge" name="Age" placeholder="年龄"  pattern="\d*" oninvalid="setCustomValidity('请输入整数');"  oninput="setCustomValidity('');">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputCountry" class="col-sm-2 control-label">国籍</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputCountry" name="Country" placeholder="国籍">
                    </div>
                  </div>
                  <div class="form-group">
