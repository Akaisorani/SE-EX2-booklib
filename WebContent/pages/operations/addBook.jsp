    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
        ...
        <li class="active"><a href="pages/operations/addBook.jsp"><i class="fa fa-circle-o text-red"></i> <span>添加新书籍</span></a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- box-body -->
              <div class="box-body">
                <form class="form-horizontal" action="addBook">
                  <div class="form-group">
                    <label for="inputISBN" class="col-sm-2 control-label">ISBN</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputISBN" name="ISBN" placeholder="ISBN" pattern="[\d-]{1,17}" oninvalid="setCustomValidity('请输入13位ISBN');"  oninput="setCustomValidity('');">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" id="selectAuthor" name="AuthorID" required></select>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">                      
                        <input type="text" class="form-control" id="inputPublishDate" name="PublishDate" placeholder="出版日期">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPrice" name="Price" placeholder="价格"  pattern="\d*(\.\d*)?" oninvalid="setCustomValidity('请输入数字');"  oninput="setCustomValidity('');">
                    </div>
                  </div>
                  <div class="form-group">
